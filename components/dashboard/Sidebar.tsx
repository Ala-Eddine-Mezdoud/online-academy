...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  ...
  if (!activePage) {
    if (pathname.startsWith("/dashboard/admin/teachers"))
      activePage = "teachers";
    else if (pathname.startsWith("/dashboard/admin/students"))
      activePage = "students";
    else if (pathname.startsWith("/dashboard/admin/courses"))
      activePage = "courses";
    else if (pathname.startsWith("/dashboard/admin/liveManagement"))
      activePage = "live";
    else if (pathname.startsWith("/dashboard/admin/notifications"))
      activePage = "notifications";
    else if (pathname.startsWith("/dashboard/admin/profile"))
      activePage = "profile";
    else if (
      pathname === "/dashboard" ||
