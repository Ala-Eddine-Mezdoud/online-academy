...
export default function AuthHeroSection({
  ...
  const orderClass =
    order === "left" ? "order-1 lg:order-1" : "order-2 lg:order-2";
  ...
  return (
    <motion.div
      ...
      className={`hidden lg:flex flex-col items-center justify-center space-y-6 ${orderClass} lg:sticky lg:top-0 lg:self-start lg:h-screen`}
    >
      <div className="w-full max-w-[80%] text-center lg:text-left">
        ...
        <p className="text-base lg:text-lg text-[#30363A]">{description}</p>
      </div>
