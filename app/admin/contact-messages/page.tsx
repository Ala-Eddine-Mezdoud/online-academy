...
import { getAllContactMessages, deleteContactMessage } from '@/app/lib/contact_messages.client';
    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">View and manage messages from students</p>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs text-gray-500 uppercase tracking-wider">Subject</th>
                ...
                filteredMessages.map((message) => (
                  <tr key={message.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">
                      <a href={`mailto:${message.email}`} className="text-blue-600 hover:text-blue-700 flex items-center gap-1">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 max-w-xs">
                      <div className="truncate">{truncateText(message.message, 40)}</div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-500">
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${selectedMessage.email}`} className="text-sm text-blue-600 hover:text-blue-700 mt-1 block">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900 mt-1">{formatDateTime(selectedMessage.created_at)}</p>
              </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete the message from &quot;{selectedMessage?.name}&quot;. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => { setIsDeleteOpen(false); setSelectedMessage(null); }}>
              Cancel
            </AlertDialogCancel>
