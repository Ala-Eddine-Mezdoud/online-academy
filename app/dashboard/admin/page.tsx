...
import { getAllEnrollments } from "@/app/models/enrollment.model";
import { checkAdminConfig } from "@/app/actions/auth.actions";
import {
  Alert,
  AlertDescription,
  AlertTitle,
    ...
    const fetchData = async () => {
      try {
        ...
        enrollmentsData?.forEach((e: any) => {
          if (e.course_id) {
            courseEnrollmentCounts[e.course_id] =
              (courseEnrollmentCounts[e.course_id] || 0) + 1;
          }
        });
        ...
        const registrationByDay: Record<
          string,
        ...
        if (enrollmentsData && enrollmentsData.length > 0) {
          ...
          const avgProgress = Math.round(
            totalProgress / enrollmentsData.length
          );
    ...
    <div className="p-8">
      ...
      {configError && (
        <Alert variant="destructive" className="mb-6">
          ...
          <AlertDescription>
            The Supabase Service Role Key is missing. You will not be able to
            create new users (Students/Teachers). Please add{" "}
            <code>SUPABASE_SERVICE_ROLE_KEY</code> to your <code>.env</code>{" "}
            file.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatsCard
          ...
          icon={Users}
          trend={{
            value: `${trends.students.value}% From last month`,
            isPositive: trends.students.isPositive,
          }}
        />
        <StatsCard
          ...
          icon={GraduationCap}
          trend={{
            value: `${trends.teachers.value}% From last month`,
            isPositive: trends.teachers.isPositive,
          }}
        />
        <StatsCard
          title="Total Courses"
          ...
          icon={BookOpen}
          trend={{
            value: `${trends.courses.value}% From last month`,
            isPositive: trends.courses.isPositive,
          }}
        />
        <StatsCard
          ...
          icon={TrendingUp}
          trend={{
            value: `${trends.enrollments.value}% From last month`,
            isPositive: trends.enrollments.isPositive,
          }}
        />
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Number of students and teachers registered in the last 14 days
        </p>
        <div className="h-80">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Number of course enrollments in the last 14 days
        </p>
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="h-64 flex items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
              <RadialBarChart
                ...
                outerRadius="90%"
                data={[
                  { name: "Progress", value: averageProgress, fill: "#3b82f6" },
                ]}
                startAngle={90}
                endAngle={-270}
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 lg:col-span-2">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Student progress breakdown by completion level
          </p>
          <div className="space-y-4 mt-6">
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  {progressDistribution.notStarted} students
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${stats.enrollments > 0 ? (progressDistribution.notStarted / stats.enrollments) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  {progressDistribution.inProgress} students
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${stats.enrollments > 0 ? (progressDistribution.inProgress / stats.enrollments) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  {progressDistribution.halfway} students
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${stats.enrollments > 0 ? (progressDistribution.halfway / stats.enrollments) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between mb-1">
                ...
                <span className="text-sm text-gray-500">
                  {progressDistribution.completed} students
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{
                    width: `${stats.enrollments > 0 ? (progressDistribution.completed / stats.enrollments) * 100 : 0}%`,
                  }}
                ></div>
              </div>
            </div>
              ...
              >
                <div>
                  <p className="font-medium text-gray-900">
                    {student.role_title || "Unknown Name"}
                  </p>
                  <p className="text-sm text-gray-500">
                    {student.wilaya || "No location"}
                  </p>
                </div>
                <span className="text-sm text-gray-500">
