...
export default function TeacherDashboard() {
  ...
  const teacherStats = [
    { label: 'Total Courses', value: stats.totalStudents.toString(), icon: Users, color: 'bg-blue-500', trend: '+12%' },
    { label: 'Active Courses', value: stats.activeCourses.toString(), icon: BookOpen, color: 'bg-green-500', trend: '+2' },
    { label: 'sessions studied', value: stats.hoursTaught.toString(), icon: Clock, color: 'bg-purple-500', trend: '+3' },
  ];
