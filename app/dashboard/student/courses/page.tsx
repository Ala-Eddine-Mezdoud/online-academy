...
import { getMyEnrolledCourses } from "@/app/models/course.model";
          ...
          {filteredCourses.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              {filteredCourses.map((course) => (
                <div
                  key={course.id}
                  className="flex flex-col bg-white rounded-xl border border-gray-200 hover:shadow-md transition-shadow overflow-hidden"
                >
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                      ...
                      {(() => {
                        ...
                        if (session) {
                          return (
                            <a
                              href={session.session_link ?? undefined}
                              target="_blank"
